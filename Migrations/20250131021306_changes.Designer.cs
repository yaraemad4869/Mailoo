...
namespace Mailoo.Migrations
{
    ...
    [Migration("20250131021306_changes")]
            ...
            modelBuilder.Entity("Mailo.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2025, 1, 31, 4, 13, 4, 251, DateTimeKind.Local).AddTicks(2530),
                            UserType = 1,
            ...
            modelBuilder.Entity("Mailo.Models.Wishlist", b =>
                {
                    ...
                    b.HasOne("Mailoo.Models.ProductVariant", null)
                        .WithMany("Wishlists")
